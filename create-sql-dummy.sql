...
--
-- Host: localhost:3306
-- Generation Time: Oct 13, 2019 at 07:50 PM
...
INSERT INTO `dogs` (`id`, `name`, `size`, `bio`, `user_id`, `age`, `sex`, `breed`, `shortDesc`) VALUES
(5, 'Aiko', 'S', 'This is a long little biography of my dog that is however long the user wants it to be. Go go go go go.', 1, 2, 0x30, 'Shiba Inu', 'Aiko is a gentle Shiba that loves to roughhouse'),
(6, 'Jasmine', 'XS', 'This is a long little biography of my dog that is however long the user wants it to be. Go go go go go.', 2, 5, 0x30, 'Toy Poodle', 'Jasmine is a firneldy poodle that loves to relax'),
(7, 'Westington', 'L', 'This is a long little biography of my dog that is however long the user wants it to be. Go go go go go.', 3, 3, 0x31, 'Rottweiler', 'Westington is a beast and likes to play rough'),
(8, 'Bow', 'M', 'This is a long little biography of my dog that is however long the user wants it to be. Go go go go go.', 4, 4, 0x31, 'Chihuahua Mix', 'Bow is a scared dog is learning to play with others');
